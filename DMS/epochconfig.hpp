...
// Time based
StaticDateTime[] = {2014,0,0,11,1}; // {0,0,0,8,0} would forces the server to start at 8am each time it is started while allowing the year, month and day to stay real time. Any values left at 0 will result in no change.
...
// Player Related
cloneCost = 50; // debt incurred on player death
